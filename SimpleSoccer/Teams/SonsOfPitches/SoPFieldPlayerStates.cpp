...
SoPGlobalPlayerState* SoPGlobalPlayerState::Instance()
{
...
void SoPGlobalPlayerState::Execute(FieldPlayer* player)                                     
{
...
bool SoPGlobalPlayerState::OnMessage(FieldPlayer* player, const Telegram& telegram)
{
  switch(telegram.Msg)
  {
  case Msg_ReceiveBall:
    {
      ...
      //change state 
      player->GetFSM()->ChangeState(SoPReceiveBall::Instance());
  ...
  case Msg_SupportAttacker:
    {
      ...
      if (player->GetFSM()->isInState(*SoPSupportAttacker::Instance()))
      {
        return true;
      }
      ...
      //change the state
      player->GetFSM()->ChangeState(SoPSupportAttacker::Instance());
  ...
  case Msg_GoHome:
    {
      ...
      player->GetFSM()->ChangeState(SoPReturnToHomeRegion::Instance());
...
SoPChaseBall* SoPChaseBall::Instance()
{
...
void SoPChaseBall::Enter(FieldPlayer* player)
{
...
void SoPChaseBall::Execute(FieldPlayer* player)                                     
{
  //if the ball is within kicking range the player changes state to SoPKickBall.
  if (player->BallWithinKickingRange())
  {
    player->GetFSM()->ChangeState(SoPKickBall::Instance());
...
void SoPChaseBall::Exit(FieldPlayer* player)
{
...
SoPSupportAttacker* SoPSupportAttacker::Instance()
{
...
void SoPSupportAttacker::Enter(FieldPlayer* player)
{
...
void SoPSupportAttacker::Execute(FieldPlayer* player)                                     
{
  //if his team loses control go back home
  if (!player->Team()->InControl())
  {
    player->GetFSM()->ChangeState(SoPReturnToHomeRegion::Instance()); return;
  } 
...
void SoPSupportAttacker::Exit(FieldPlayer* player)
{
...
SoPReturnToHomeRegion* SoPReturnToHomeRegion::Instance()
{
...
void SoPReturnToHomeRegion::Enter(FieldPlayer* player)
{
  player->Steering()->ArriveOn();
  ...
  #ifdef PLAYER_STATE_INFO_ON
  debug_con << "Player " << player->ID() << " enters SoPReturnToHome state" << "";
  #endif
}

void SoPReturnToHomeRegion::Execute(FieldPlayer* player)
{
...
void SoPWait::Enter(FieldPlayer* player)
{
  #ifdef PLAYER_STATE_INFO_ON
...
void SoPWait::Execute(FieldPlayer* player)
{    
...
SoPKickBall* SoPKickBall::Instance()
{
...
void SoPKickBall::Enter(FieldPlayer* player)
{
...
void SoPKickBall::Execute(FieldPlayer* player)
{ 
  ...
  {   
    ...
    player->GetFSM()->ChangeState(SoPDribble::Instance());
  }   
}
...
SoPDribble* SoPDribble::Instance()
{
...
void SoPDribble::Enter(FieldPlayer* player)
{
  //let the team know this player is controlling
  player->Team()->SetControllingPlayer(player);
...
void SoPDribble::Execute(FieldPlayer* player)
{
...
SoPReceiveBall* SoPReceiveBall::Instance()
{
...
void SoPReceiveBall::Enter(FieldPlayer* player)
{
...
void SoPReceiveBall::Execute(FieldPlayer* player)
{
...
void SoPReceiveBall::Exit(FieldPlayer* player)
{
  player->Steering()->ArriveOff();
  player->Steering()->PursuitOff();
