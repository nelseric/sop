...
//
//------------------------------------------------------------------------
AbstSoccerTeam::AbstSoccerTeam(Goal*        home_goal,
                       Goal*        opponents_goal,
                       SoccerPitch* pitch,
...
//------------------------------------------------------------------------
void AbstSoccerTeam::CalculateClosestPlayerToBall()
{
...
//------------------------------------------------------------------------
PlayerBase* AbstSoccerTeam::DetermineBestSupportingAttacker()
{
  double ClosestSoFar = MaxFloat;
...
//------------------------------------------------------------------------
bool AbstSoccerTeam::FindPass(const PlayerBase*const passer,
                         PlayerBase*&           receiver,
                         Vector2D&              PassTarget,
                         double                  power,
...
//------------------------------------------------------------------------
bool AbstSoccerTeam::GetBestPassToReceiver(const PlayerBase* const passer,
...
//  getting intercepted
//------------------------------------------------------------------------
bool AbstSoccerTeam::isPassSafeFromAllOpponents(Vector2D                from,
                                            Vector2D                target,
                                            const PlayerBase* const receiver,
                                            double     PassingForce)const
{
...
//------------------------------------------------------------------------
bool AbstSoccerTeam::CanShoot(Vector2D  BallPos,
                          double     power, 
...
//------------------------------------------------------------------------
void AbstSoccerTeam::ReturnAllFieldPlayersToHome()const
{
...
//------------------------------------------------------------------------
void AbstSoccerTeam::Render()const
{
  std::vector<PlayerBase*>::const_iterator it = m_Players.begin();
...
void AbstSoccerTeam::RegisterPlayers ()
{
...
PlayerBase* AbstSoccerTeam::GetPlayerFromID(int id)const
{
  std::vector<PlayerBase*>::const_iterator it = m_Players.begin();
...
void AbstSoccerTeam::SetPlayerHomeRegion(int plyr, int region)const
{
...
//-----------------------------------------------------------------------------
bool AbstSoccerTeam::AllPlayersAtHome()const
{
  std::vector<PlayerBase*>::const_iterator it = m_Players.begin();
...
//-----------------------------------------------------------------------------
void AbstSoccerTeam::RequestPass(FieldPlayer* requester)const
{
...
//-----------------------------------------------------------------------------
bool AbstSoccerTeam::isOpponentWithinRadius(Vector2D pos, double rad)
{
